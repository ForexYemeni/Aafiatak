...
// playNotificationSound removed — NotificationBell singleton handles all sounds
// to prevent duplicate sounds from ChatSystem + NotificationBell both playing
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (!isOpen && data.length > prevLength) {
          ...
          // Sound is handled by NotificationBell singleton — no need to play here
        }
