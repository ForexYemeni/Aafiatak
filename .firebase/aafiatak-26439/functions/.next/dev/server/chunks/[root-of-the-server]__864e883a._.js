...
async function POST(request) {
    try {
        ...
        let admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminByUsername"])(username);
        // If no admin exists at all, auto-create the default admin
        if (!admin) {
            const existingAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFirstAdmin"])();
            if (!existingAdmin) {
                // No admin in the database yet - auto-seed with default credentials
                if (username === DEFAULT_USERNAME && password === DEFAULT_PASSWORD) {
                    const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(DEFAULT_PASSWORD, 10);
                    admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdmin"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__864e883a._.js.map