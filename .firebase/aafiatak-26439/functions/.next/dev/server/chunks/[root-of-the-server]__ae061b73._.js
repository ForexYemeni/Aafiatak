...
const hasValidConfig = firebaseConfig.projectId && firebaseConfig.clientEmail && firebaseConfig.privateKey && firebaseConfig.projectId !== 'your-project-id' && firebaseConfig.privateKey !== 'your-private-key' && firebaseConfig.privateKey.includes('-----BEGIN');
...
"[project]/src/app/api/admin/init/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const admin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdmin"])({
            username,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae061b73._.js.map