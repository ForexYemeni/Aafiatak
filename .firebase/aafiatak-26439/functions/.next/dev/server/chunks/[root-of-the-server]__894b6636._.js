...
"[project]/src/app/api/admin/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const services = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllServices"])();
...
async function POST(request) {
    try {
        ...
        if (!name || !description || price === undefined) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'الاسم والوصف والسعر مطلوبون'
            }, {
                status: 400
            });
        }
        const service = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createService"])({
            name,
            description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__894b6636._.js.map