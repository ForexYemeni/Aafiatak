...
"[project]/src/app/api/admin/payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const payments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllPaymentMethods"])();
...
async function POST(request) {
    try {
        ...
        if (!name || !accountInfo) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'الاسم ومعلومات الحساب مطلوبان'
            }, {
                status: 400
            });
        }
        const payment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaymentMethod"])({
            name,
            accountInfo,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63b8e586._.js.map